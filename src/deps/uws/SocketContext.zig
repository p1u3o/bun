...
pub const SocketContext = opaque {
    ...
    pub fn connect(this: *SocketContext, ssl: bool, host: [*:0]const u8, port: i32, options: i32, socket_ext_size: i32, has_dns_resolved: *i32, local_address: ?[*:0]const u8, local_port: u16) ?*anyopaque {
        return c.us_socket_context_connect(@intFromBool(ssl), this, host, port, options, socket_ext_size, has_dns_resolved, local_address, local_port);
    }
...
pub const c = struct {
    ...
    pub extern fn us_socket_context_connect(ssl: i32, context: *SocketContext, host: [*:0]const u8, port: i32, options: i32, socket_ext_size: i32, has_dns_resolved: *i32, local_address: ?[*:0]const u8, local_port: u16) ?*anyopaque;
